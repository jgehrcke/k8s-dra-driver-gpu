...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComputeDomainCliqueInfo) DeepCopyInto(out *ComputeDomainCliqueInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComputeDomainCliqueInfo.
func (in *ComputeDomainCliqueInfo) DeepCopy() *ComputeDomainCliqueInfo {
	if in == nil {
		return nil
	}
	out := new(ComputeDomainCliqueInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ComputeDomainStatus) DeepCopyInto(out *ComputeDomainStatus) {
	*out = *in
	...
	if in.Cliques != nil {
		...
		*out = make([]*ComputeDomainCliqueInfo, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ComputeDomainCliqueInfo)
